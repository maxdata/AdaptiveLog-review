...
class DiscriminatePred(SentenceEvaluator):
    """
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        for step, batch in enumerate(self.dataloader):
            ...
            with torch.no_grad():
                ...
                correct.append([aa[step],torch.argmax(prediction, dim=1).item()])
        print(len(correct))




        save_json(correct,'/home/mlp/adaptive/discriminate.json')
        return 1
